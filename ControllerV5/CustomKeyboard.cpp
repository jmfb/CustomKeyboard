...
//Above numpad macro keys N1-4
const int MKEY_N1 = 2001;
const int MKEY_N2 = 2002;
const int MKEY_N3 = 2003;
const int MKEY_N4 = 2004;

const int minMacroKey = MKEY_N1;
const int maxMacroKey = MKEY_N4;
...
int leftHandKeyMap[topRowCount][leftHandColumnCount] =
{
	...
	{ KEY_LEFT_CTRL,  KEY_LEFT_GUI, KEY_LEFT_ALT, leftHyperKey,  KEY_SPACE, 0,      0 }
};
...
int rightHandKeyMap[bottomRowCount][rightHandColumnCount] =
{
	...
	{ 0,       0,       KEY_SPACE, rightHyperKey, KEY_RIGHT_ALT, KEY_RIGHT_GUI,  KEY_MENU,        KEY_RIGHT_CTRL }
};
...
private:
	void ScanRow(int row)
	{
		...
		//Based on length of cables, it can take some time for signal to stabilize.
		delay(1);
	}

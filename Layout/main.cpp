...
int main()
{
	...
	Board("Right Hand",
		...
		MakeRow("Row 1",
			outerEdge, padding,
			Key{ 2, "R3" }, Key{ 1, "7" }, Key{ 1, "8" }, Key{ 1, "9" }, Key{ 1, "0" }, Key{ 1, "MINUS" }, Key{ 1, "EQUALS" }, Key{ 2, "BACKSPACE" },
			padding, innerEdge, padding,
			Key{ 1, "INSERT" }, Key{ 1, "HOME" }, Key{ 1, "PAGE_UP" },
			padding, innerEdge, padding,
		...
		MakeRow("Row 2",
			outerEdge, padding,
			Key{ 1.5, "R4" }, Key{ 1, "Y" }, Key{ 1, "U" }, Key{ 1, "I" }, Key{ 1, "O" }, Key{ 1, "P" }, Key{ 1, "LEFT_BRACE" }, Key{ 1, "RIGHT_BRACE" }, Key{ 1.5, "BACKSLASH" },
			padding, innerEdge, padding,
			Key{ 1, "DELETE" }, Key{ 1, "END" }, Key{ 1, "PAGE_DOWN" },
			padding, innerEdge, padding,
		...
		MakeRow("Row 3",
			outerEdge, padding,
			Key{ 1.75, "R5" }, Key{ 1, "H" }, Key{ 1, "J" }, Key{ 1, "K" }, Key{ 1, "L" }, Key{ 1, "SEMICOLON" }, Key{ 1, "QUOTE" }, Key{ 2.25, "ENTER" },
			padding, Spacer{ innerEdge.Width() * 2 + Key{ 1 }.Width() * 3 + padding.Width() * 2 }, padding,
		...
		MakeRow("Row 4",
			outerEdge, padding,
			Key{ 2.25, "R6" }, Key{ 1, "N" }, Key{ 1, "M" }, Key{ 1, "COMMA" }, Key{ 1, "PERIOD" }, Key{ 1, "FORWARD_SLASH" }, Key{ 2.75, "RIGHT_SHIFT" },
			padding, innerEdge, Spacer{ Key{ 1 }.Width() }, padding,
			Key{ 1, "UP" },
			padding, Spacer{ Key{ 1 }.Width() }, innerEdge, padding,
		...
		MakeRow("Row 5",
			outerEdge, padding,
			Key{ 1, "R7" }, Key{ 2.25, "RIGHT_SPACE" }, Key{ 1.75, "RIGHT_HYPER" }, Key{ 1.25, "RIGHT_ALT" }, Key{ 1.25, "RIGHT_WIN" }, Key{ 1.25, "RIGHT_MENU" }, Key{ 1.25, "RIGHT_CTRL" },
			padding, innerEdge, padding,
			Key{ 1, "LEFT" }, Key{ 1, "DOWN" }, Key{ 1, "RIGHT" },
			padding, innerEdge, padding,
